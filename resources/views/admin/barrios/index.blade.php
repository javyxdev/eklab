...
@section('css')
    <style>
        ...
        #barriosTable td, #barriosTable th {
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table id="barriosTable" class="table table-striped table-bordered table-hover">
                <thead>
                <tr>
                    <th>ID</th>
                    <th>NOMBRE</th>
                ...
                @foreach($barrios as $barrio)
                    <tr>
                        ...
                        <td width="100px" class="text-center">
                            <div class="btn-group">
                                <a class="btn btn-success btn-sm" href="{{route('admin.barrios.edit', $barrio)}}" title="Editar Registro">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <button class="btn btn-danger btn-sm" onclick="eliminarRegistro({{$barrio->id}})" title="Eliminar Registro">
