...
@section('css')
    <style>
        ...
        #municipiosTable td, #municipiosTable th {
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table id="municipiosTable" class="table table-striped table-bordered table-hover">
                <thead>
                <tr>
                    <th>ID</th>
                    <th>NOMBRE</th>
                ...
                @foreach($municipios as $municipio)
                    <tr>
                        ...
                        <td width="100px" class="text-center">
                            <div class="btn-group">
                                <a class="btn btn-success btn-sm" href="{{route('admin.municipios.edit', $municipio)}}" title="Editar Municipio">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <button class="btn btn-danger btn-sm" onclick="eliminarRegistro({{$municipio->id}})" title="Eliminar Municipio">
